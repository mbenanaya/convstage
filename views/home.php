...
<body id="body">
    ...
    <section class="home_section">
        <input type="hidden" name="stud_cne" readonly id="stud_cne" value="<?= $_SESSION['cne'] ?>">
        <div class="d-flex justify-content-center py-3">
            <div class="alert alert-success alert-dismissible fade show row py-3 mx-1" role="alert">
                ...
                <span>
                    <i type="button" class="fa-solid fa-xmark close col position-absolute top-50 me-1" data-dismiss="alert" aria-label="Close" style="font-size: 30px;"></i>
                </span>
            </div>
        </div>
        <div class="d-flex justify-content-center pt-5 pb-5">
            <button type="button" class="btn downloadButton" data-bs-toggle="modal" data-bs-target="#downloadModal"><i class="fa fa-plus"></i> Créer Convention</button>
                            ...
                            <form id="conv_form" style="font-size: .96rem">
                                <div class="infos row row-cols-1 row-cols-sm-2 row-cols-md-4 row-cols-lg-3 row-cols-xl-3 py-3 mx-1 rounded-3">
                                    ...
                                    <div class="form-group col col-md-4 col-lg-4 col-xl-4 mt-2 mt-sm-3 mt-md-3 mt-lg-3">
                                        ...
                                        <input class="form-control date ps-md-2 date-input" type="date" name="datedebut" id="datedebut">
                                    </div>

                                    <div class="form-group col col-md-4 col-lg-4 col-xl-4 mt-2 mt-sm-3 mt-md-3 mt-lg-3">
                                        <label class="mb-2" for="datefin">Date fin</label>
                                        <input class="form-control date ps-md-2 date-input" type="date" name="datefin" id="datefin">
                                    </div>

                                    <div class="form-group col col-md-4 col-lg-4 col-xl-4 mt-2 mt-sm-3 mt-md-3 mt-lg-3">
                                        <label class="mb-2" for="intitule">Projet du stage</label>
                                        <input class="form-control ps-md-2" type="text" id="intitule" name="intitule" placeholder="Intitulé du projet du stage">
                                    </div>
                                    ...
                                    <div class="form-group col col-md-8 col-lg-8 col-xl-8 mt-2 mt-sm-3 mt-md-3 mt-lg-3">
                                        ...
                                        <textarea id="description" name="description" class="form-control ps-md-2" cols="10" rows="4"></textarea>
                                    </div>
                                ...
                                <label>
                                    <small class="form-text fw-bold mx-1">Selectionner une entreprise parmi les noms
                                        d'entreprises existent 👇, s'il n'existe plus saisir le </small><span class="writing fw-bold">&#x270D;</span>
                                </label>
                                <div class="infos row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 py-3 mx-1 rounded-3">
                                    ...
                                    <div class="entrNom form-group col position-relative">
                                        ...
                                        <ul class="col list-unstyled position-absolute border rounded-3 z-3 mt-2" id="list_entr"></ul>
                                    </div>
                                ...
                                <div class="infos row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-3 row-cols-xl-3 py-3 mx-1 rounded-3">
                                    <div class="form-group col mt-2 mt-sm-3 mt-md-3 mt-lg-0">
                                        ...
                                        <input class="form-control" type="text" name="nomResp" id="nomResp" placeholder="Nom du responsable">
                                    </div>
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="crCnvButt" name="crCnvButt" class="btn btn-success submit_button">Créer</button>
                                </div>
                            </form>
                        </div>
                    </div>
        ...
        <div class="wrapper d-flex justify-content-center px-3 px-sm-4 px-md-2"></div>
