<nav class="navbar navbar-expand-md navbar-dark bg-dark">
    <div class="container-fluid">
        <a class="navbar-brand m-0" href="/convstage/">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="nav_ul navbar-nav ms-auto mb-2 mb-lg-0">
                ...
                <li class="nav-item d-sm-block d-md-none w-25">
                    <div class="navbar-nav">
                        <p class="fst_link showSt nav-link text-white px-1" id="showSt" name="showSt">Statistiques</p>
                    </div>
                </li>

                <li class="nav-item d-sm-block d-md-none">
                    <div class="navbar-nav">
                        <a class="lo_link fst_link small nav-link text-white px-1" href="logout">
                            Se Deconnecter
                        </a>
                    </div>
                </li>
                ...
                <li class="nav-item ms-md-auto d-none d-md-block">
                    <div class="navbar-nav">
                        <p class="fst_link showSt nav-link text-white" id="showSt" name="showSt">Statistiques</p>
                    </div>
                </li>
