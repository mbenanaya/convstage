...
<!-- <link rel="shortcut icon" href="<?php echo __DIR__ . "/../assets/images/logo-fstg.jpg"; ?>" type="image/x-icon"> -->
<link rel="shortcut icon" href="../assets/images/logo-fstg.jpg" type="image/x-icon">
<link
    rel="stylesheet"
...
<!-- views/assets/images/logo-fstg.jpg -->