...
include_once 'views/assets/dompdf/vendor/autoload.php';
use Dompdf\Dompdf;
...
function generatePDF()
{
    ...
    $path_fst = __DIR__ .  '/views/assets/images/logo-fstg.jpg';
    ...
    // $filename = __DIR__. '/conventions/Convention_' . $nom . '_' . $cne . uniqid() . '.pdf';
    // file_put_contents($filename, $dompdf->output());

    // return $filename;

    $filename = 'Convention_' . $nom . '_' . $cne . uniqid() . '.pdf';
    $fullPath = __DIR__ . '/conventions/' . $filename;
